...
export const tr = {
  ...
  exams: {
    ...
    supervisor: "Sorumlu",
    // K-81 · gözetmenler (sorumluya EK, isteğe bağlı, 0..N)
    invigilators: "Gözetmenler",
    pickInvigilators: "Gözetmen ekleyin (isteğe bağlı)",
    invigilatorsHint: "İsteğe bağlı. Sınav sorumlusu bu listeye eklenemez.",
    // Kartta isim değil SAYI yazıyor (kart dar); isimler ipucunda.
    invigilatorCount: (n: number) => `${n} gözetmen`,
